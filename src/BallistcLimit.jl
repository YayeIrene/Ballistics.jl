...
function normalised(penetration::Impact, proj::Projectile, tar_mat::AbstractMaterial)
...
function coefficient(tar_mat::MetallicParts{ST}, proj::Projectile)
...
function coefficient(tar_mat::MetallicParts{AL}, proj::Projectile)
...
function coefficient(tar_mat::MetallicParts{TI}, proj::Projectile)
...
function coefficient_AP(tar_mat::MetallicParts{AL}, proj::Projectile)
    C_s = 1795
    bs = 0.61
    ps=1.0
    return C_s, bs, ps
...
function coefficient_AP(tar_mat::MetallicParts{TI}, proj::Projectile)
    C_s = 1437
    bs = 0.75
    ps=1.0
    return C_s, bs, ps
...
function coefficient_AP(tar_mat::MetallicParts{ST}, proj::Projectile)
...
function Vfactor(proj::Projectile, tar_mat::AbstractMaterial, penetration::Impact)
    Ap_e = effective_area(proj,tar_mat)
...
function ballistic_limit(penetration::Impact, proj::Projectile, tar_mat::MetallicParts)
...
function attack_type(proj::Projectile, tar_mat::AbstractMaterial)
...
function ballistic_limit_sharp(penetration::Impact, proj::Projectile, tar_mat::MetallicParts, proj_type::AbstractProjectile)
    X, Y, Z = normalised(penetration, proj, tar_mat)
    L,D,Ap_f, Ap_nf = equivalent_cylinder(proj.type, proj)
...
function ballistic_limit_sharp(penetration::Impact, proj::Projectile, tar_mat::MaterialUnkown, proj_type::AbstractProjectile)
    return 0
end
function ballistic_limit(penetration::Impact, proj::Projectile, tar_mat::MaterialUnkown, proj_type::AbstractProjectile)
    return 0
end
